...
export default class Kuesioner extends Component {
  ...
  handleAddButton = () => {
    ...
    fetch(`${process.env.REACT_APP_API_URL}/kuesioner`, requestOptions)
  ...
  handleClickDelete = (id) => {
    ...
    fetch(`${process.env.REACT_APP_API_URL}/kuesioner/${id}`, requestOptions)
      .then((response) => response.json())
      .then((result) => {
        this.fetchDataKuesioner();
      })
  ...
  updateKuesioner = () => {
    ...
    fetch(
      `${process.env.REACT_APP_API_URL}/kuesioner/${this.state.idQuesioner}`,
      requestOptions
    )
      .then((response) => response.json())
      .then((result) => {
